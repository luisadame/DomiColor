...
//
//
        var $dd7df4 = exports.default || module.exports;
      
      if (typeof $dd7df4 === 'function') {
        $dd7df4 = $dd7df4.options;
      }
    
        /* template */
        Object.assign($dd7df4, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "color", on: { click: _vm.copyColor } }, [
    _c("h2", { staticClass: "color__title" }, [_vm._v(_vm._s(_vm.title))]),
    _vm._v(" "),
    _c("span", { staticClass: "color__model" }, [_vm._v(_vm._s(_vm.model))]),
    _vm._v(" "),
    _c("div", { staticClass: "color__models" }, [
      _c(
        "button",
        {
          on: {
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$dd7df4', $dd7df4);
          } else {
            api.reload('$dd7df4', $dd7df4);
          }
        }
...
var DomiColor = function () {
    ...
    _createClass(DomiColor, [{
        ...
        value: function containerTransition() {
            this.imageCanvas.style.opacity = 1;
        }
    }, {
        key: 'copyColor',
        value: function copyColor(e) {
            _utils2.default.selectText(e.target);
            document.execCommand('copy');
            window.getSelection().removeAllRanges();
            console.log('Copied!');
        }
        ...
        key: 'createColorElement',
        value: function createColorElement(_ref) {
        ...
        value: function processPalette(palette) {
            ...
            var swatches = Object.entries(palette).filter(function (swatch) {
                return swatch[1] != null;
            });
            var fragment = document.createDocumentFragment();
            swatches.forEach(function (swatch) {
                return fragment.appendChild(_this3.createColorElement(swatch).$el);
            });
